...
int chek_square(char **table, struct Pos *pos)
{
    int x;
    int y;
...
void print_square(char **table,struct Pos pos)
{
    int x;
    int y;
...
void get_max_square(char **table,struct Pos *poss, int total)
{
    int i;
    int max_i;
    int *max_p;
    ...
    print_square(table,poss[max_p[0]]);
    free(max_p);
}
...
int optimation(char **table, int total)
{
    ...
    get_max_square(table,poss,total);
    free(poss);
    return (1);
}